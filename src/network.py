...
class Conv2d(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, relu=True, padding='same', bn=False, dilation=1):
        super(Conv2d, self).__init__()

        pad = int((kernel_size - 1) / 2) if padding == 'same' else padding
